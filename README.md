A bright theme that was mainly started as GUI theme for my [Ivy](https://github.com/sixsixfive/ivy) icon theme and to see if it is possible to create a text only theme (yes, SVG's are text files!).
