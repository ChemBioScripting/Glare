...
var uri = NetUtil.newURI("resource://glarelightextension/menubar/menubar.css");
...
function startup(aData, aReason) {
  ...
  this.resource.setSubstitution("glarelightextension", alias);
...
function shutdown(aData, aReason) {
  ...
  this.resource.setSubstitution("glarelightxtension", null);
}