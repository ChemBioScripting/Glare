...
var uri = NetUtil.newURI("resource://glareboldextension/menubar/menubar.css");
...
function startup(aData, aReason) {
  ...
  this.resource.setSubstitution("glareboldextension", alias);
...
function shutdown(aData, aReason) {
  ...
  this.resource.setSubstitution("glareboldextension", null);
}